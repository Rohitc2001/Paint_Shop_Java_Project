...
<body>
    <div class="sidenav">
        ...
        <img alt="logo" src="images/rainbow.png" width="80px">
           <h2>Paint-It Registration Page</h2>
           ...
           <div class="login-form">
              ...
              <table>
               ...
               <tr>
              		...
              		<td><input type="password" name="email" placeholder="enter your e-mail"></td>
              </tr>
              ...
              <tr>
              		<td></td>
              <!-- 	<td><button lass="btn btn-black"><a href="login.jsp" style="color:black;">Login</a></button> -->
